...
var tunes = '[{'
  + '"tunes": [\n'
    ...
    + '{\n'
      ...
      + '"time": "Reel",\n'
      + '"key": "D dor",\n'
      + '"description": "A hypnotic sort of reel with a lot of G in it for being a D minor tune. The name references the Broken Earth series by N. K. Jemisin, which is incredibly good, and you need to read it if you haven\'t.",\n'
      + '"date": "Sept 2018",\n'
      + '"author": "Mark and Jess",\n'
      + '"audio": "the silver",\n'
      + '"pdf": "The Silver"\n'
